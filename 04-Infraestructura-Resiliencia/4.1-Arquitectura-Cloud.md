...
flowchart TB
 subgraph Global["🌐 Capa Global"]
        Users["👥 Usuarios<br/>Mobile + Web<br/>12 países"]
        CDN["CloudFront CDN<br/>400+ Edge Locations<br/>Cache Hit Ratio: 85%"]
        DNS["Route53<br/>Geo DNS + Health Checks<br/>Failover &lt; 30s"]
  end
 subgraph RegionPrimary["☁️ AWS Region: us-east-1 (Primary)"]
    direction TB
     subgraph AZ1["📍 AZ-A<br/>Capacity: 33%"]
     ...
     subgraph AZ2["📍 AZ-B<br/>Capacity: 33%"]
     ...
     subgraph AZ3["📍 AZ-C<br/>Capacity: 33%"]
     ...
     subgraph SharedSvcs["🔧 Shared Services<br/>Cross-AZ"]
 ...
 subgraph RegionDR["☁️ AWS Region: us-west-2 (DR)<br/>🔴 Pasivo - Activación Manual"]
 ...
 subgraph OnPremise["🏢 Legacy Datacenter<br/>Strangler Fig Migration"]
        Bridge["Direct Connect<br/>1 Gbps Dedicated<br/>Latency: 5-10ms"]
        LegacySystem["Legacy J2EE Monolith<br/>Oracle 12c Database<br/>HSM Crypto Hardware<br/>🔴 Decomissioning: 12 meses"]
  end
    Users --> CDN
    CDN --> DNS
